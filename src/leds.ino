void actualizeTimeWord(int fhour, int fminute, int fsecond) {
	//WORD CLOCK
	...
	clockSeconds(fsecond);
	FastLED.show();
}


void actualizeTimeDigital(int fhour, int fminute, int fsecond) {
	//WORD CLOCK

	FastLED.clear();
	if (fhour < 10) {
		printDigital(fhour, 7);
	}
	else {
		String strHour = (String)fhour;
		String  shour1 = strHour.substring(0, 1);
		String  shour2 = strHour.substring(1, 2);
		printDigital(shour1.toInt(), 0);
		printDigital(shour2.toInt(), 7);
	}

	if (fminute < 10) {
		printDigital(0, 130);
		printDigital(fminute, 137);
	}
	else {
		String strMin = (String)fminute;
		String  smin1 = strMin.substring(0, 1);
		String  smin2 = strMin.substring(1, 2);
		printDigital(smin1.toInt(), 130);
		printDigital(smin2.toInt(), 137);
	}
...
void printDigital(int digit, int valPosition2) {
	switch (digit) {
	case 0:
		leds[valPosition2 + 1] = COLOUR[theColour];
		leds[valPosition2 + 2] = COLOUR[theColour];
		leds[valPosition2 + 3] = COLOUR[theColour];
		leds[valPosition2 + 4] = COLOUR[theColour];
		leds[valPosition2 + 5] = COLOUR[theColour];
		leds[valPosition2 + 17] = COLOUR[theColour];
		leds[valPosition2 + 21] = COLOUR[theColour];
		leds[valPosition2 + 33] = COLOUR[theColour];
		leds[valPosition2 + 37] = COLOUR[theColour];
		leds[valPosition2 + 49] = COLOUR[theColour];
		leds[valPosition2 + 53] = COLOUR[theColour];
		leds[valPosition2 + 65] = COLOUR[theColour];
		leds[valPosition2 + 69] = COLOUR[theColour];
		leds[valPosition2 + 81] = COLOUR[theColour];
		leds[valPosition2 + 85] = COLOUR[theColour];
		leds[valPosition2 + 97] = COLOUR[theColour];
		leds[valPosition2 + 98] = COLOUR[theColour];
		leds[valPosition2 + 99] = COLOUR[theColour];
		leds[valPosition2 + 100] = COLOUR[theColour];
		leds[valPosition2 + 101] = COLOUR[theColour];
		break;
	case 1:
		leds[valPosition2 + 3] = COLOUR[theColour];
		leds[valPosition2 + 18] = COLOUR[theColour];
		leds[valPosition2 + 19] = COLOUR[theColour];
		leds[valPosition2 + 33] = COLOUR[theColour];
		leds[valPosition2 + 35] = COLOUR[theColour];
		leds[valPosition2 + 51] = COLOUR[theColour];
		leds[valPosition2 + 67] = COLOUR[theColour];
		leds[valPosition2 + 83] = COLOUR[theColour];
		leds[valPosition2 + 99] = COLOUR[theColour];
		break;
	case 2:
		leds[valPosition2 + 1] = COLOUR[theColour];
		...
		leds[valPosition2 + 37] = COLOUR[theColour];
		leds[valPosition2 + 49] = COLOUR[theColour];
		leds[valPosition2 + 50] = COLOUR[theColour];
		leds[valPosition2 + 51] = COLOUR[theColour];
		leds[valPosition2 + 52] = COLOUR[theColour];
		leds[valPosition2 + 53] = COLOUR[theColour];
		leds[valPosition2 + 65] = COLOUR[theColour];
		leds[valPosition2 + 81] = COLOUR[theColour];
		leds[valPosition2 + 97] = COLOUR[theColour];
